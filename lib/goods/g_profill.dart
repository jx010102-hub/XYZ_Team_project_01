  ...
  Widget _buildSettingItem(
    ...
    return Column(
      children: [
        ...
        if (title != '알림' && title != '테마' && title != '언어' && title != '회사 정보' && title != '앱 정보')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        automaticallyImplyLeading: false, // 뒤로가기 버튼 자동 생성 방지 (탭바 내부에 있으므로)
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            const Divider(height: 1, thickness: 1, indent: 20, endIndent: 20, color: Colors.grey),
